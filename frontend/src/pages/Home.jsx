              ...
              <svg className="hero-visual" viewBox="0 0 420 460" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Illustration of a classical courthouse facade with a balanced scale of justice">
                <defs>
                  ...
                  <linearGradient id="pillarGrad" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <stop offset="100%" stopColor="#B38B40"/>
                  </linearGradient>
                ...
                <g clipPath="url(#frameClip)">
                  <circle className="hero-visual-star" cx="60" cy="70" r="1.4" fill="#C5A059"/>
                  <circle className="hero-visual-star" cx="340" cy="55" r="1.6" fill="#C5A059"/>
                  <circle className="hero-visual-star" cx="300" cy="110" r="1.1" fill="#C5A059"/>

                  <path d="M70 190 L210 120 L350 190 Z" fill="#1E293B" stroke="#C5A059" strokeWidth="1"/>
                  <rect x="60" y="188" width="300" height="14" fill="#0F172A" stroke="#C5A059" strokeWidth="0.75"/>
                  ...
                  <rect x="30" y="375" width="360" height="10" fill="#0B1221"/>

                  <rect className="hero-visual-sweep" x="0" y="0" width="120" height="460" fill="url(#sweepGrad)"/>

                  <g className="hero-visual-beam">
                    <line x1="140" y1="150" x2="280" y2="150" stroke="#C5A059" strokeWidth="2.5" strokeLinecap="round"/>
                    <line x1="210" y1="118" x2="210" y2="150" stroke="#C5A059" strokeWidth="2.5"/>
                    <circle className="hero-visual-glow" cx="210" cy="118" r="46" fill="#C5A059" opacity="0.15"/>
                    <circle cx="210" cy="118" r="7" fill="#C5A059"/>

                    <line x1="140" y1="150" x2="140" y2="172" stroke="#C5A059" strokeWidth="1.6"/>
                    <path d="M124 172 Q140 194 156 172" stroke="#C5A059" strokeWidth="1.6" fill="none"/>
                    <line x1="124" y1="172" x2="156" y2="172" stroke="#C5A059" strokeWidth="1.6"/>

                    <line x1="280" y1="150" x2="280" y2="172" stroke="#C5A059" strokeWidth="1.6"/>
                    <path d="M264 172 Q280 194 296 172" stroke="#C5A059" strokeWidth="1.6" fill="none"/>
                    <line x1="264" y1="172" x2="296" y2="172" stroke="#C5A059" strokeWidth="1.6"/>
                  </g>
                </g>
                <rect x="1" y="1" width="418" height="458" fill="none" stroke="#C5A059" strokeOpacity="0.1"/>
              </svg>
