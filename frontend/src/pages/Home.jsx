      ...
      <section className="section" id="team">
          <div className="container">
            ...
            <div className="team-grid" style={{ display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap' }}>
              <Link to="/team/pankaj-sinha" className="team-card reveal" style={{ textDecoration: 'none', color: 'inherit', maxWidth: '250px', width: '100%' }}>
              ...
              <Link to="/team/tariq-adeeb" className="team-card reveal" style={{ textDecoration: 'none', color: 'inherit', maxWidth: '250px', width: '100%' }}>
                <div className="team-photo" style={{ backgroundImage: 'url(/team/tariq.jpeg)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
                <h3>Tariq Adeeb</h3>
                <p className="team-role">Advocate</p>
              </Link>
              <Link to="/team/kulwinder" className="team-card reveal" style={{ textDecoration: 'none', color: 'inherit', maxWidth: '250px', width: '100%' }}>
              ...
              <Link to="/team/garima" className="team-card reveal" style={{ textDecoration: 'none', color: 'inherit', maxWidth: '250px', width: '100%' }}>
                <div className="team-photo" style={{ backgroundImage: 'url(/team/garima.jpeg)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
                <h3>Garima</h3>
                <p className="team-role">Advocate</p>
              </Link>
              <Link to="/team/humaira" className="team-card reveal" style={{ textDecoration: 'none', color: 'inherit', maxWidth: '250px', width: '100%' }}>
